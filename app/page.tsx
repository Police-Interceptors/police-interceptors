            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {categories.map((item) => (
                <a
                  ...
                  className="group overflow-hidden rounded-2xl border border-slate-700 bg-slate-950 transition hover:border-orange-400"
                >
                  <div className="relative h-40 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4">
                      ...
                      <div className="text-sm text-slate-300">Search official listings</div>
                    </div>
                  </div>
                </a>
              ))}
